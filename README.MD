# Lux Exp Movies SSR App – Setup and Execution Guide
...
### Movie Details
![Movie Details](./public/movie-detail.png)
...
## 🐳 5) Run with Docker Compose (no Redis)
...
> The runtime uses `tsx` as a loader, so you don’t need `ts-node`.
